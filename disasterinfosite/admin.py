...
# adminModelImports
from .models import EmbedSnugget, TextSnugget, SnuggetSection, SnuggetSubSection, Location, SiteSettings, SupplyKit, ImportantLink, EQ_SeattleFault72_kingco, Summer_kingco, Flood_DamInundation, Flood_kingco, LSLD_kingco, Volcano_Lahar_kingco, Volcano_kingco, EQ_URM_DensityZones_seattle, EQ_Nisqual68_kingco, Hubs_Nearest_seattle, Flood_500yr_wUrban_kingco, EQ_Tsunami_SeaFault72_kingco, Winter_kingco, Fire_kingco, Flood_CMZ_kingco, EQ_Cascadia_kingco, LSLD_steepgradezone, EQ_kingco, Fire_WUI_kingco_only, Flood_nearest_sand_distr, Flood_100yr_wUrban_kingco, EQ_Liquefact_kingco, LSLD_ExistingAreas_kingco, LSLD_Prone_kingco, LSLD_existing_features
...
# DO NOT MANUALLY EDIT CODE IN THIS SECTION - IT WILL BE OVERWRITTEN
# adminLists
    list_display = ('shortname', 'section', 'sub_section', 'EQ_SeattleFault72_kingco_filter', 'Summer_kingco_filter', 'Flood_DamInundation_filter', 'Flood_kingco_filter', 'LSLD_kingco_filter', 'Volcano_Lahar_kingco_filter', 'Volcano_kingco_filter', 'EQ_URM_DensityZones_seattle_filter', 'EQ_Nisqual68_kingco_filter', 'Hubs_Nearest_seattle_filter', 'Flood_500yr_wUrban_kingco_filter', 'EQ_Tsunami_SeaFault72_kingco_filter', 'Winter_kingco_filter', 'Fire_kingco_filter', 'Flood_CMZ_kingco_filter', 'EQ_Cascadia_kingco_filter', 'LSLD_steepgradezone_filter', 'EQ_kingco_filter', 'Fire_WUI_kingco_only_filter', 'Flood_nearest_sand_distr_filter', 'Flood_100yr_wUrban_kingco_filter', 'EQ_Liquefact_kingco_filter', 'LSLD_ExistingAreas_kingco_filter', 'LSLD_Prone_kingco_filter', 'LSLD_existing_features_filter')
    list_filter = ('section', 'sub_section', 'EQ_SeattleFault72_kingco_filter', 'Summer_kingco_filter', 'Flood_DamInundation_filter', 'Flood_kingco_filter', 'LSLD_kingco_filter', 'Volcano_Lahar_kingco_filter', 'Volcano_kingco_filter', 'EQ_URM_DensityZones_seattle_filter', 'EQ_Nisqual68_kingco_filter', 'Hubs_Nearest_seattle_filter', 'Flood_500yr_wUrban_kingco_filter', 'EQ_Tsunami_SeaFault72_kingco_filter', 'Winter_kingco_filter', 'Fire_kingco_filter', 'Flood_CMZ_kingco_filter', 'EQ_Cascadia_kingco_filter', 'LSLD_steepgradezone_filter', 'EQ_kingco_filter', 'Fire_WUI_kingco_only_filter', 'Flood_nearest_sand_distr_filter', 'Flood_100yr_wUrban_kingco_filter', 'EQ_Liquefact_kingco_filter', 'LSLD_ExistingAreas_kingco_filter', 'LSLD_Prone_kingco_filter', 'LSLD_existing_features_filter')
    ...
    fieldsets = (
        ...
        ('Filters', {
            ...
            'fields': (('EQ_SeattleFault72_kingco_filter', 'Summer_kingco_filter', 'Flood_DamInundation_filter', 'Flood_kingco_filter', 'LSLD_kingco_filter', 'Volcano_Lahar_kingco_filter', 'Volcano_kingco_filter', 'EQ_URM_DensityZones_seattle_filter', 'EQ_Nisqual68_kingco_filter', 'Hubs_Nearest_seattle_filter', 'Flood_500yr_wUrban_kingco_filter', 'EQ_Tsunami_SeaFault72_kingco_filter', 'Winter_kingco_filter', 'Fire_kingco_filter', 'Flood_CMZ_kingco_filter', 'EQ_Cascadia_kingco_filter', 'LSLD_steepgradezone_filter', 'EQ_kingco_filter', 'Fire_WUI_kingco_only_filter', 'Flood_nearest_sand_distr_filter', 'Flood_100yr_wUrban_kingco_filter', 'EQ_Liquefact_kingco_filter', 'LSLD_ExistingAreas_kingco_filter', 'LSLD_Prone_kingco_filter', 'LSLD_existing_features_filter'))
        })
    )
# END OF GENERATED CODE BLOCK
######################################################
